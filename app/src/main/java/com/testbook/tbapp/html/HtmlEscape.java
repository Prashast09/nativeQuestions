 ...
 * =============================================================================
 */
package com.testbook.tbapp.html;
 ...
 *       needs of the scenario). Its values are defined by the {@link com.testbook.tbapp.html.HtmlEscapeLevel}
 *       enum.</li>
 ...
 *       {@link com.testbook.tbapp.html.HtmlEscapeType} enum.</li>
 * </ul>
 * <p>
...
public final class HtmlEscape {
     ...
     * <ul>
     *   <li><tt>type</tt>:
     *       {@link com.testbook.tbapp.html.HtmlEscapeType#HTML5_NAMED_REFERENCES_DEFAULT_TO_DECIMAL}</li>
     *   <li><tt>level</tt>:
     *       {@link com.testbook.tbapp.html.HtmlEscapeLevel#LEVEL_2_ALL_NON_ASCII_PLUS_MARKUP_SIGNIFICANT}</li>
     * </ul>
     * <p>
     ...
     *       {@link com.testbook.tbapp.html.HtmlEscapeType#HTML5_NAMED_REFERENCES_DEFAULT_TO_DECIMAL}</li>
     *   <li><tt>level</tt>:
     *       {@link com.testbook.tbapp.html.HtmlEscapeLevel#LEVEL_1_ONLY_MARKUP_SIGNIFICANT}</li>
     * </ul>
     * <p>
     *   This method is <strong>thread-safe</strong>.
     * </p>
    ...
    public static String escapeHtml5Xml(final String text) {
        return escapeHtml(text, com.testbook.tbapp.html.HtmlEscapeType.HTML5_NAMED_REFERENCES_DEFAULT_TO_DECIMAL,
                com.testbook.tbapp.html.HtmlEscapeLevel.LEVEL_1_ONLY_MARKUP_SIGNIFICANT);
    }
     ...
     * <ul>
     *   <li><tt>type</tt>:
     *       {@link com.testbook.tbapp.html.HtmlEscapeType#HTML4_NAMED_REFERENCES_DEFAULT_TO_DECIMAL}</li>
     *   <li><tt>level</tt>:
     *       {@link com.testbook.tbapp.html.HtmlEscapeLevel#LEVEL_2_ALL_NON_ASCII_PLUS_MARKUP_SIGNIFICANT}</li>
     * </ul>
     * <p>
    ...
    public static String escapeHtml4(final String text) {
        return escapeHtml(text, com.testbook.tbapp.html.HtmlEscapeType.HTML4_NAMED_REFERENCES_DEFAULT_TO_DECIMAL,
                com.testbook.tbapp.html.HtmlEscapeLevel.LEVEL_2_ALL_NON_ASCII_PLUS_MARKUP_SIGNIFICANT);
    }
     ...
     *   {@link com.testbook.tbapp.html.HtmlEscapeType} and {@link com.testbook.tbapp.html.HtmlEscapeLevel}
     *   argument values.
     * </p>
     * <p>
     ...
     *
     * @param text the <tt>String</tt> to be escaped.
     * @param type the type of escape operation to be performed, see {@link com.testbook.tbapp.html.HtmlEscapeLevel}.
     * @return The escaped result <tt>String</tt>. As a memory-performance improvement, will return the exact
     *         same object as the <tt>text</tt> input argument if no escaping modifications were required (and
     *         no additional <tt>String</tt> objects will be created during processing). Will
     *         return <tt>null</tt> if <tt>text</tt> is <tt>null</tt>.
    ...
    public static void escapeHtml5(final char[] text, final int offset, final int len, final Writer writer)
                                   throws IOException {
        escapeHtml(text, offset, len, writer, com.testbook.tbapp.html.HtmlEscapeType.HTML5_NAMED_REFERENCES_DEFAULT_TO_DECIMAL,
                com.testbook.tbapp.html.HtmlEscapeLevel.LEVEL_2_ALL_NON_ASCII_PLUS_MARKUP_SIGNIFICANT);
    }
    ...
    public static void escapeHtml4(final char[] text, final int offset, final int len, final Writer writer)
                                   throws IOException {
        escapeHtml(text, offset, len, writer, com.testbook.tbapp.html.HtmlEscapeType.HTML4_NAMED_REFERENCES_DEFAULT_TO_DECIMAL,
                com.testbook.tbapp.html.HtmlEscapeLevel.LEVEL_2_ALL_NON_ASCII_PLUS_MARKUP_SIGNIFICANT);
    }
     ...
     * @param writer the <tt>java.io.Writer</tt> to which the escaped result will be written. Nothing will
     *               be written at all to this writer if <tt>text</tt> is <tt>null</tt>.
     * @param type the type of escape operation to be performed, see {@link com.testbook.tbapp.html.HtmlEscapeType}.
     * @param level the escape level to be applied, see {@link com.testbook.tbapp.html.HtmlEscapeLevel}.
     * @throws IOException if an input/output exception occurs
     */
    public static void escapeHtml(final char[] text, final int offset, final int len, final Writer writer,
                                  final com.testbook.tbapp.html.HtmlEscapeType type, final com.testbook.tbapp.html.HtmlEscapeLevel level)
                                  throws IOException {
